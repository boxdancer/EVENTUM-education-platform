...
async def clean_tables(async_session_test):
    """Clears data from all tables before running the test function"""
...
async def client() -> Generator[TestClient, Any, None]:
    """
    Creates a new FastAPI TestClient that uses the 'db_session' fixture to override the 'get_db' dependency that was
